...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url(); ?>assets/pages/examples/contacts.html" class="nav-link">Contact</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url(); ?>home" class="nav-link">Blog</a>
      </li>
    </ul>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="<?php echo base_url(); ?>assets/#">
                        <img class="contacts-list-img" src="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/dist/img/user7-128x128.jpg">
